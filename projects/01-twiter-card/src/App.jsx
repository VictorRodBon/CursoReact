...
export function App(){
    ...
    const victor={formatUserName: formatUserName,username:"Victor_Rod_Bonn", name:"Victor Rodriguez Bon"};
    ...
    return(
        <section className="App">
            ...
            <TwiterFollowCard 
                {...victor} // convertimos las propiedades del objeto props del componente
            />
